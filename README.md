...
- 구글 플레이 서비스 라이브러리 설정 필요. [구글 플레이 서비스 라이브러리 설정 방법](https://developers.google.com/android/guides/setup)을 참고하여 직접 추가하면 된다.
    ...
    > 안드로이드 스튜디오와 이클립스 설정이 다릅니다. 다운받은 소스에서 샘플을 참고하세요. 안드로이드 스튜디오인 경우는 **build.gradle > dependencies**에 **compile 'com.google.android.gms:play-services-ads:7.5.0'**를  추가해주면 됩니다.
